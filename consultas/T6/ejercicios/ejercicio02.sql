...
alter table Edicion 
add constraint fk_edicion foreign key (ISBN) references Libro;


alter table Libro 
add constraint  fk_autor foreign key (Dni_autor) references autor;


alter table Libro 
add constraint  fk_genero foreign key (Cod_genero) references genero;
 

alter table Libro 
add constraint fk_editorial foreign key (Cod_editorial) references editorial;
